...
import io.github.natank25.scp_byo.block.custom.ElevatorFloorBlock;
...
import io.github.natank25.scp_byo.block.custom.SlidingDoorBlock;
...
public class ModBlocks {
    ...
    public static final Block WHITE_WALL = registerBlock("white_wall", new ExtendableBlock(FabricBlockSettings.of(Material.STONE).strength(5,1200).requiresTool(),10), ModItems.SCP_FONDATION_ITEM_GROUP);
    public static final Block CONCRETE_WALL = registerBlock("concrete_wall", new ExtendableBlock(FabricBlockSettings.of(Material.STONE).strength(5,1200).requiresTool(),10), ModItems.SCP_FONDATION_ITEM_GROUP);
    public static final Block OFFICE_WALL = registerBlock("office_wall", new ExtendableBlock(FabricBlockSettings.of(Material.STONE).strength(5,1200).requiresTool(),10), ModItems.SCP_FONDATION_ITEM_GROUP);
    ...
    private static Item registerBlockItem(String name, Block block, ItemGroup itemGroup) {
        ...
        return Registry.register(Registries.ITEM, new Identifier(scp_byo.MOD_ID, name), new BlockItem(block, new Item.Settings()));
    }
